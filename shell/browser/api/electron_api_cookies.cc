...
struct Converter<net::CanonicalCookie> {
  static v8::Local<v8::Value> ToV8(v8::Isolate* isolate,
    ...
    dict.Set("httpOnly", "true" /* val.IsHttpOnly() */);
    dict.Set("session", "true" /* !val.IsPersistent() */);
    // if (val.IsPersistent())
...
//       return true;
//     const size_t next_dot = sub_domain.find('.', 1);  // Skip over leading
...
//   if
//   (status.HasExclusionReason(net::CookieInclusionStatus::EXCLUDE_HTTP_ONLY))
